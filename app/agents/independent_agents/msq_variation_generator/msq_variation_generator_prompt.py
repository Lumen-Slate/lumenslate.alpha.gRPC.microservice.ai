...
MSQ_VARIATION_GENERATOR_PROMPT = """
Your task is to generate new unique variation of a given question alongwith its options and the correct answer indices. You have to generate 4 variations of the question.
...
A  MSQ (Multiple Select Question) is a question that can have more than one correct answer.
