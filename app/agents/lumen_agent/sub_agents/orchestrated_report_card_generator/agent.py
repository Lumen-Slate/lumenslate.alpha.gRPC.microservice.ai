...
from .orchestrated_report_card_generator_prompt import orchestrated_report_card_generator_prompt
...
orchestrated_report_card_generator = LlmAgent(
    ...
    instruction=orchestrated_report_card_generator_prompt,
