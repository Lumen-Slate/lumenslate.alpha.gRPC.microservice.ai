...
from app.agents.agent_handlers.main_agent_handler import main_agent_handler
from app.agents.agent_handlers.rag_agent_handler import rag_agent_handler


class OrchestratedAgentService(BaseService):
    ...
    def Agent(self, request, context):
        ...
        try:
            ...
            try:
                response = loop.run_until_complete(main_agent_handler(request))
